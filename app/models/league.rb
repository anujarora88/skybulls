class League < ActiveRecord::Base
  ...
  attr_accessible :virtual_money,:algo_name, :category, :description, :market, :title, :users, :start_time, :end_time, :latest_registration_time, :commission, :invitation_only, :buy_in, :max_users, :min_users
